...
updateUsers.get('/', async (req, res, next) => {
...
updateUsers.put('/password', async (req, res, next) => {
    const { password } = req.body;
    const user_id = req.user.user_id;
...
updateUsers.put('/email', async (req, res, next) => {
...
updateUsers.put('/username', async (req, res, next) => {
...
updateUsers.delete('/delete', async (req, res, next) => {
    const user_id = req.user.user_id;
